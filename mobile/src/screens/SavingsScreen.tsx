...
export default function SavingsScreen({ navigation }: any) {
  ...
  const groupedData: GroupedData[] = useMemo(() => {
    ...
    sorted.forEach((s) => {
      ...
      if (!groups[dateKey]) {
        groups[dateKey] = { savings: [], totalAmount: 0 };
      }
  ...
  const renderGroup = ({ item }: { item: GroupedData }) => (
    <View style={styles.dateGroup}>
      <View style={styles.dateHeader}>
        ...
        <Text style={styles.dateBalance}>
          + ₽{item.totalAmount.toLocaleString("ru-RU", { minimumFractionDigits: 2 })}
        </Text>
      </View>
      ...
      <View style={styles.statsGrid}>
        <View style={styles.statCard}>
          <View style={[styles.statIcon, styles.statIconOrange]}>
            <Ionicons name="wallet-outline" size={18} color={theme.warning} />
          </View>
          <View style={styles.statInfo}>
            <Text style={styles.statLabel}>Баланс</Text>
            <Text style={[styles.statValue, totalBalance >= 0 ? styles.statPositive : styles.statNegative]}>
        ...
        <View style={styles.statCard}>
          <View style={[styles.statIcon, styles.statIconBlue]}>
            <Ionicons name="pie-chart-outline" size={18} color={theme.accentMuted} />
          </View>
          <View style={styles.statInfo}>
        ...
        <View style={styles.statCard}>
          <View style={[styles.statIcon, styles.statIconPurple]}>
            <Ionicons name="time-outline" size={18} color={theme.purple} />
          </View>
          <View style={styles.statInfo}>
